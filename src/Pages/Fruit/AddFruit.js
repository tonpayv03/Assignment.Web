                                        ...
                                        <Card.Body>
                                            ...
                                            <Form noValidate validated={validated} onSubmit={handleSubmit} disabled >
                                                ...
                                                <Row className="mb-2">
                                                    ...
                                                    <Form.Group as={Col} xs={12} sm={12} md={8}controlId="nameId">
                                                        <Form.Control type="file"
                                                            ...
                                                            required
                                                            className='disabled-valid-style enebled-invalid-style'
                                                            size="lg"
                                                ...
                                                <Row className='horizontal-center'>
                                                    ...
                                                    <Button type="button" className="mt-2 mb-2 mx-2 btn btn-secondary" onClick={() => { thisHistory.goBack() }} style={{ width: 'auto', minWidth: 140 }} >Cancle</Button>
                                                </Row>
